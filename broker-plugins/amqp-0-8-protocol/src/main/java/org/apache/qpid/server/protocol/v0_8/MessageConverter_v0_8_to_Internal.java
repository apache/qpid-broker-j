...
public class MessageConverter_v0_8_to_Internal implements MessageConverter<AMQMessage, InternalMessage>
{
    ...
    @Override
    public InternalMessage convert(final AMQMessage serverMessage, final NamedAddressSpace addressSpace)
    {
        return convert(serverMessage, addressSpace, 0, false);
    }

    @Override
    public InternalMessage convert(final AMQMessage serverMessage,
    ...
    private InternalMessage convert(final AMQMessage serverMessage,
                                    final NamedAddressSpace addressSpace,
                                    final int maximumMessageDecompressionSize,
    ...
    private static Object convertMessageBody(final AMQMessage serverMessage,
        ...
        if (data != null && data.length != 0)
        {
            if (converter != null)
            {
                return AmqpCompoundMimeContentToObjectConverter.toObject(converter, data,
                        serverMessage.getMaxNestedObjects());
            }
