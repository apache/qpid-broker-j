...
public class QueryEngineException extends RuntimeException
{
    ...
    protected QueryEngineException(String message)
    {
        super(message);
    }

    protected QueryEngineException(Throwable throwable)
    {
        super(throwable);
    }

    protected QueryEngineException(String message, Throwable throwable)
    {
