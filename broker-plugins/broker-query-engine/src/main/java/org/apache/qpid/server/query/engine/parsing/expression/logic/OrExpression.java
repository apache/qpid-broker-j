 ...
 */
public class OrExpression<T> extends AbstractExpressionNode<T, Boolean> implements Predicate<T>
{
    /**
     ...
     */
    public OrExpression(final String alias, final ExpressionNode<T, ?> left, final ExpressionNode<T, ?> right)
    {
    ...
    public Boolean apply(final T value)
    {
        ...
        return left.or(right).test(value);
    }
