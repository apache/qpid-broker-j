...
/**
 * RTRIM takes a string parameter and removes trailing spaces from it. The implicit conversion to
 * strings follows the existing rules for data type conversions. If any argument is NULL, RTRIM returns NULL.
 *
...
public class RightTrimExpression<T, R> extends AbstractFunctionExpression<T, String>
{
    /**
     ...
     */
    public RightTrimExpression(final String alias, final List<ExpressionNode<T, ?>> args)
    {
        super(alias, args);
