...
public class QueryValidationException extends QueryEngineException
{
    ...
    protected QueryValidationException(Throwable throwable)
    {
        super(throwable);
    }

    protected QueryValidationException(String message, Throwable throwable)
    {
    ...
    {
        return new QueryValidationException(String.format(message, args));
    }
}
