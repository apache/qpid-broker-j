 ...
 */
public class MultiplyExpression<T, R> extends AbstractArithmeticExpression<T, R>
{
    /**
     ...
     */
    public MultiplyExpression(final String alias, final ExpressionNode<T, R> left, final ExpressionNode<T, R> right)
    {
    ...
    public R apply(final T value)
    {
        ...
        final BigDecimal result = new BigDecimal(arg1.toString()).multiply(new BigDecimal(arg2.toString()));
