...
/**
 * Comparison LESS THAN OR EQUAL operation. Evaluates left expression against right expression.
 *
...
public class LessThanOrEqualExpression<T, R> extends AbstractComparisonExpression<T, Boolean>
{
     ...
     */
    public LessThanOrEqualExpression(final ExpressionNode<T, ?> left, final ExpressionNode<T, ?> right)
    {
        super(left, right);
        _operator = "<=";
    }
