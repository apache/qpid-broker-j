...
public class GreaterThanExpression<T, R> extends AbstractComparisonExpression<T, Boolean>
{
    /**
     ...
     */
    public GreaterThanExpression(final ExpressionNode<T, ?> left, final ExpressionNode<T, ?> right)
    {
        super(left, right);
        _operator = ">";
    }
