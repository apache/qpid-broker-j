...
public class PropertiesSectionConstructor extends DescribedListSectionConstructor<PropertiesSection>
{
    ...
    @Override
    protected PropertiesSection createObject(final QpidByteBuffer encodedForm, final ValueHandler valueHandler)
    {
        return new PropertiesSection(encodedForm, valueHandler);
    }
