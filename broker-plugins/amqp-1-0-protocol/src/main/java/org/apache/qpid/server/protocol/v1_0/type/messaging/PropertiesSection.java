...
public class PropertiesSection extends AbstractSection<Properties, Properties>
{
    ...
    public PropertiesSection(final QpidByteBuffer encodedForm, final int maxNestedObjects)
    {
        super(encodedForm, maxNestedObjects);
    }

    public PropertiesSection(final QpidByteBuffer encodedForm, final ValueHandler valueHandler)
    {
