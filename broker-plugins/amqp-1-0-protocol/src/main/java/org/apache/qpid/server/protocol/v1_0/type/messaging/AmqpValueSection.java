...
{
    public AmqpValueSection(final QpidByteBuffer encodedForm)
    {
        this(encodedForm, AMQPConnection_1_0.DEFAULT_CODEC_MAX_NESTED_OBJECTS);
    }

    public AmqpValueSection(final QpidByteBuffer encodedForm, final int maxNestedObjects)
    {
        super(encodedForm, maxNestedObjects);
    }

    public AmqpValueSection(final QpidByteBuffer encodedForm, final ValueHandler valueHandler)
    {
