...
public class JMSMessagePropertyExpression implements PropertyExpression<Filterable>
{
    ...
    static
    {
        ...
        JMS_PROPERTY_EXPRESSIONS.put(JMS_MESSAGE_ID,
                                     (Expression<Filterable>) message -> AmqpMessageIdHelper.INSTANCE.toMessageIdString(
        ...
        JMS_PROPERTY_EXPRESSIONS.put(JMS_CORRELATION_ID,
                                     (Expression<Filterable>) message -> AmqpMessageIdHelper.INSTANCE.toCorrelationIdString(
