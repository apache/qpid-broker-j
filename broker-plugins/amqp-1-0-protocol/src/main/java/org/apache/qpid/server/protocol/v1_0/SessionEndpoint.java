...
public class SessionEndpoint
{
    ...
    public SessionEndpoint(final AMQPConnection_1_0 connectionEndpoint)
    {
        this(connectionEndpoint, UnsignedInteger.valueOf(0));
    }

    public SessionEndpoint(final AMQPConnection_1_0 connectionEndpoint, Begin begin)
    {
        this(connectionEndpoint, UnsignedInteger.valueOf(0));
    ...
    public SessionEndpoint(final AMQPConnection_1_0 connectionEndpoint, UnsignedInteger nextOutgoingId)
    {
    ...
    {
        _connection.sendFrame(this.getSendingChannel(), frameBody);
    }


    private int send(final FrameBody frameBody, QpidByteBuffer payload)
    {
        return _connection.sendFrame(this.getSendingChannel(), frameBody, payload);
    }
...
*/
    ...
    public SendingLinkEndpoint createSendingLinkEndpoint(final String name, final Source source, final org.apache.qpid.server.protocol.v1_0.type.Target target, Map<Binary, Outcome> unsettled)
    {
    ...
    public SendingLinkEndpoint createSendingLinkEndpoint(final String name, final Source source,
                                                         final org.apache.qpid.server.protocol.v1_0.type.Target target,
                                                         Map<Binary, Outcome> unsettled,
