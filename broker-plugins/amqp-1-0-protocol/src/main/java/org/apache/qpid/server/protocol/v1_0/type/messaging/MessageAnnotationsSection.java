...
public class MessageAnnotationsSection extends AbstractSection<Map<Symbol,Object>, MessageAnnotations>
{
    ...
    public MessageAnnotationsSection(final QpidByteBuffer encodedForm, final int maxNestedObjects)
    {
        super(encodedForm, maxNestedObjects);
    }

    public MessageAnnotationsSection(final QpidByteBuffer encodedForm, final ValueHandler valueHandler)
    {
