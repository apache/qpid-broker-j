 ...
 * {@link RuleSetCreator#grant(Integer, String, Permission, Operation, ObjectType, ObjectProperties)} method. Then, the
...
public class RuleSetTest extends QpidTestCase
{
                                      ...
                                      ObjectProperties properties)
    {
        ...
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, operation, objectType, properties);
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.VIRTUALHOSTNODE, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH));
        RuleSet ruleSet = createRuleSet();
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ObjectProperties.WILD_CARD));
        RuleSet ruleSet = createRuleSet();
        assertEquals(Result.ALLOWED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH)));
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
        assertEquals(Result.ALLOWED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH)));
        assertEquals(Result.ALLOWED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(DENIED_VH)));
    }
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ObjectProperties.WILD_CARD));
        RuleSet ruleSet = createRuleSet();
        assertEquals(Result.DENIED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH)));
        assertEquals(Result.DENIED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(DENIED_VH)));
    }
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(DENIED_VH));
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH));
        RuleSet ruleSet = createRuleSet();
        assertEquals(Result.ALLOWED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(ALLOWED_VH)));
        assertEquals(Result.DENIED, ruleSet.check(_testSubject, Operation.ACCESS, ObjectType.VIRTUALHOST, new ObjectProperties(DENIED_VH)));
    }
    ...
    public void testVirtualHostAccessAllowPermissionWithVirtualHostNameOtherPredicate() throws Exception
    {
        ...
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, properties);
        RuleSet ruleSet = createRuleSet();
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, new ObjectProperties(Property.VIRTUALHOST_NAME, ALLOWED_VH));
        RuleSet ruleSet = createRuleSet();
    ...
    {
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.EXCHANGE, new ObjectProperties(Property.VIRTUALHOST_NAME, ALLOWED_VH));
        RuleSet ruleSet = createRuleSet();
    ...
    */
    public void testTemporaryUnnamedQueueConsume()
    {
        ...
        _ruleSetCreator.grant(0, TEST_USER, Permission.ALLOW, Operation.CONSUME, ObjectType.QUEUE, temporary);
        ruleSet = createRuleSet();
        assertEquals(1, ruleSet.getRuleCount());
    ...
    public void testTemporaryQueueFirstConsume()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.CONSUME, ObjectType.QUEUE, normal);
        _ruleSetCreator.grant(2, TEST_USER, Permission.ALLOW, Operation.CONSUME, ObjectType.QUEUE, temporary);
        ruleSet = createRuleSet();
    ...
    public void testTemporaryQueueLastConsume()
    {
        ...
        // should not matter if the temporary permission is processed first or last
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.CONSUME, ObjectType.QUEUE, temporary);
        _ruleSetCreator.grant(2, TEST_USER, Permission.ALLOW, Operation.CONSUME, ObjectType.QUEUE, normal);
        ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testFirstNamedSecondTemporaryQueueDenied()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, named);
        _ruleSetCreator.grant(2, TEST_USER, Permission.DENY, Operation.CREATE, ObjectType.QUEUE, namedTemporary);
        ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testFirstTemporarySecondNamedQueueDenied()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.DENY, Operation.CREATE, ObjectType.QUEUE, namedTemporary);
        _ruleSetCreator.grant(2, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, named);
        ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testFirstTemporarySecondDurableThirdNamedQueueDenied()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.DENY, Operation.CREATE, ObjectType.QUEUE, namedTemporary);
        _ruleSetCreator.grant(2, TEST_USER, Permission.DENY, Operation.CREATE, ObjectType.QUEUE, namedDurable);
        _ruleSetCreator.grant(3, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, named);
        ruleSet = createRuleSet();
    ...
    public void testNamedTemporaryQueueAllowed()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, namedTemporary);
        _ruleSetCreator.grant(2, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, named);
        ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testNamedTemporaryQueueDeniedAllowed()
    {
        ...
        _ruleSetCreator.grant(1, TEST_USER, Permission.ALLOW, Operation.CREATE, ObjectType.QUEUE, namedTemporary);
        _ruleSetCreator.grant(2, TEST_USER, Permission.DENY, Operation.CREATE, ObjectType.QUEUE, named);
        ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    {
        _ruleSetCreator.grant(1, Rule.ALL, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
        assertEquals(1, ruleSet.getRuleCount());
    ...
    public void testGroupsSupported()
    {
        ...
        _ruleSetCreator.grant(1, allowGroup, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        _ruleSetCreator.grant(2, deniedGroup, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testAllowDeterminedByRuleOrder()
    {
        ...
        _ruleSetCreator.grant(1, user, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        _ruleSetCreator.grant(2, group, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testDenyDeterminedByRuleOrder()
    {
        ...
        _ruleSetCreator.grant(1, group, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        _ruleSetCreator.grant(2, user, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
        assertEquals(2, ruleSet.getRuleCount());
    ...
    public void testUserInMultipleGroups()
    {
        ...
        _ruleSetCreator.grant(1, allowedGroup, Permission.ALLOW, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        _ruleSetCreator.grant(2, deniedGroup, Permission.DENY, Operation.ACCESS, ObjectType.VIRTUALHOST, ObjectProperties.EMPTY);
        RuleSet ruleSet = createRuleSet();
