...
public class RuleBasedAccessControlProviderImplTest extends QpidTestCase
{
                                      ...
                                      final String attributeValue)
    {
        ...
        expected.put(attributeName, attributeValue);
        expected.put(ObjectProperties.Property.NAME, _nameAttributeValue);

        assertEquals(expected, new HashMap<>(rule.getAttributes()));
    }
