...
public interface GraylogLogger<X extends GraylogLogger<X>> extends GelfAppenderConfiguration, ConfiguredObject<X>
{
    ...
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.PORT_AS_STRING,
            description = "The graylog server port number.", validator = "org.apache.qpid.server.model.validator.Port")
    int getPort();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.RECONNECTION_INTERVAL_AS_STRING,
            description = "The reconnection interval.", validator = "org.apache.qpid.server.model.validator.AtLeastZero")
    int getReconnectionInterval();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.CONNECTION_TIMEOUT_AS_STRING,
            description = "The connection timeout.", validator = "org.apache.qpid.server.model.validator.AtLeastZero")
    int getConnectionTimeout();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.MAXIMUM_RECONNECTION_ATTEMPTS_AS_STRING,
            description = "The maximum reconnection attempts.", validator = "org.apache.qpid.server.model.validator.AtLeastZero")
    int getMaximumReconnectionAttempts();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.RETRY_DELAY_AS_STRING,
            description = "The retry delay.", validator = "org.apache.qpid.server.model.validator.AtLeastZero")
    int getRetryDelay();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.MESSAGES_FLUSH_TIMEOUT_AS_STRING,
            description = "The messages flush time out at logger stop.", validator = "org.apache.qpid.server.model.validator.AtLeastZero")
    int getMessagesFlushTimeOut();

    @Override
    @ManagedAttribute(defaultValue = GelfAppenderDefaults.MESSAGE_BUFFER_CAPACITY_AS_STRING,
            description = "The capacity of the message buffer.", validator = "org.apache.qpid.server.model.validator.AtLeastOne")
    ...
    @ManagedAttribute(description = "Additional static fields for the GELF log message.",
            validator = "org.apache.qpid.server.logging.logback.validator.GelfMessageStaticFieldsValidator")
