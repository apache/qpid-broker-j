/* ConfiguredObjectFilterParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ConfiguredObjectFilterParserTokenManager.java */
/*
 *
...
static final int[] jjnextStates = {
   37, 38, 43, 44, 33, 34, 35, 23, 24, 25, 1, 2, 4, 8, 9, 11, 
   27, 28, 19, 20, 41, 42, 45, 46, 
};
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public ConfiguredObjectFilterParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public ConfiguredObjectFilterParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
