...
public class TopicExchangeResultTest extends QpidTestCase
{

    public void testProcessMessageForUnfilteredDestinations()
    {
    ...
    public void testProcessMessageForFilteredDestinations()
    {
        final TopicExchangeResult result = new TopicExchangeResult();
