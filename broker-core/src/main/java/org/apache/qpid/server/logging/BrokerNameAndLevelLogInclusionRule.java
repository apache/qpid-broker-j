...
@ManagedObject( category = false, type = BrokerNameAndLevelLogInclusionRule.TYPE)
public interface BrokerNameAndLevelLogInclusionRule<X extends BrokerNameAndLevelLogInclusionRule<X>> extends BrokerLogInclusionRule<X>
{
