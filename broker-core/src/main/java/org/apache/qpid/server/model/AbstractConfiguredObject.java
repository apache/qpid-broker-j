...
public abstract class AbstractConfiguredObject<X extends ConfiguredObject<X>> implements ConfiguredObject<X>
{
    ...
    protected void postResolve()
    {
        ...
        {
            _createdTime = AttributeValueConverter.LONG_CONVERTER.convert(getActualAttributes().get(CREATED_TIME), this);
        }
        ...
        {
            _lastUpdatedTime = AttributeValueConverter.LONG_CONVERTER.convert(getActualAttributes().get(LAST_UPDATED_TIME), this);
        }
    }
